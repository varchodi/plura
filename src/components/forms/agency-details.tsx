...
const AgencyDetails = ({ data }: Props) => {
  ...
  const handleDeleteAgency = async () => {
    ...
    //del agency (WIP : discontinue the subscription)
    ...
    <AlertDialog>
      <Card className='w-full'>
        ...
        <CardContent>
          ...
          {!data?.id && 
            <div className='flex flex-col md:flex-row md:items-center justify-between rounded-lg border-destructive gap-4 p-4 mt-4'>
              <div>
                <div>Danger Zone</div>
              </div>
